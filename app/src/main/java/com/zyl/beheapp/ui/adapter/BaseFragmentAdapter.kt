...
class BaseFragmentAdapter : FragmentPagerAdapter {
    ...
    constructor(fm: FragmentManager, fragmentList: List<Fragment>, mTitles: Array<String>) : super(fm) {
    ...
    private fun setFragments(fm: FragmentManager, fragments: List<Fragment>, mTitles: Array<String>) {
        this.mTitles = mTitles
